...
import { x, calculateSum } from "./sum.js"; // yeh import wala pattern MJS ko follow krne k liye kiya h isko (ES Modules, mjs bhi khte h) isse phle wale pattern ko jaha require ka use kr rhe the usko (cjs Common JS module khte the)
